...
import excel using ".\raw_data\hs_test_data\fy2011_ghsgt_ayp-school.xls"  , firstrow 
...
rename (SCHOOL_YEAR SYSTEM_ID SYSTEM_NAME SCHOOL_ID SCHOOL_NAME) (YEAR SYSTEMID SYSTEMNAME SCHOOLID SCHOOLNAME2011)
...
replace SCHOOLNAME = "The Academy at Wood's Mill" if SCHOOLNAME == "Wood's Mill Non-Traditional School" & Lookup1 == "7760210"
replace _merge = 3 if _merge == 1 & SCHOOLNAME == "The Academy at Wood's Mill" & Lookup1 == "7760210"


list if regexm(Lookup1,"7830103")
replace SCHOOLNAME = "CCAT School" if SCHOOLNAME == "CCAT High School" & Lookup1 == "78301030103"
replace _merge = 3 if _merge == 1 & SCHOOLNAME == "CCAT School" & Lookup1 == "78301030103"
...
save ".\temp_data\cleaned_hs_test_data_2011_ELA", replace
...
save ".\temp_data\cleaned_hs_test_data_2011_MTH", replace
...
merge 1:1 SYSTEMID SCHOOLID YEAR SYSTEMNAME SCHOOLNAME ASSESSMENT_TYPE_CODE Lookup1 using ".\temp_data\cleaned_hs_test_data_2011_ELA", nogen





save ".\temp_data\cleaned_hs_test_data_2011", replace
