...
import excel using ".\raw_data\hs_test_data\fy2008_ghsgt_ayp-school.xls"  , firstrow 
...
rename (SCHOOL_YEAR SYSTEM_ID SYSTEM_NAME SCHOOL_ID SCHOOL_NAME) (YEAR SYSTEMID SYSTEMNAME SCHOOLID SCHOOLNAME2008)
...
save ".\temp_data\cleaned_hs_test_data_2008_ELA", replace
...
save ".\temp_data\cleaned_hs_test_data_2008_MTH", replace
...
merge 1:1 SYSTEMID SCHOOLID YEAR SYSTEMNAME SCHOOLNAME ASSESSMENT_TYPE_CODE Lookup1 using ".\temp_data\cleaned_hs_test_data_2008_ELA", nogen





save ".\temp_data\cleaned_hs_test_data_2008", replace
