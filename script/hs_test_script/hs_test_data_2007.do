...
import excel using ".\raw_data\hs_test_data\fy2007_ghsgt_ayp-school.xls"  , firstrow 
...
rename (SCHOOL_YEAR SYSTEM_ID SYSTEM_NAME SCHOOL_ID SCHOOL_NAME) (YEAR SYSTEMID SYSTEMNAME SCHOOLID SCHOOLNAME2007)


merge 1:1 SCHOOLNAME2007 Lookup1 using ".\temp_data\hs_identifier_2007"
...
save ".\temp_data\cleaned_hs_test_data_2007_ELA", replace
...
import excel using ".\raw_data\hs_test_data\fy2007_ghsgt_ayp-school.xls"  , firstrow  clear
...
save ".\temp_data\cleaned_hs_test_data_2007_MTH", replace
...
merge 1:1 SYSTEMID SCHOOLID YEAR SYSTEMNAME SCHOOLNAME ASSESSMENT_TYPE_CODE Lookup1 using ".\temp_data\cleaned_hs_test_data_2007_ELA", nogen





save ".\temp_data\cleaned_hs_test_data_2007", replace
