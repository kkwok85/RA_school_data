...
import excel using ".\raw_data\personnel_data\cpi_2010-1_rpc_school.xls"
...
(FISCAL_YEAR	PERIOD	SYSTEM_ID	SYSTEM_NAME	SCHOOL_ID	SCHOOLNAME2010	///
...
duplicates report SCHOOLNAME2010 Lookup1  
...
replace SCHOOLNAME = "Classic City Performance Learning Center" if SCHOOLNAME == "Classic City High School" & Lookup1 == "6290104"
replace _merge = 3 if _merge == 1 & SCHOOLNAME == "Classic City Performance Learning Center" & Lookup1 == "6290104"
...
save ".\temp_data\cleaned_personnel_data_2010", replace
