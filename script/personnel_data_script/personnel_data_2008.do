...
import excel using ".\raw_data\personnel_data\cpi_2008-1_rpc_school.xls"
...
(FISCAL_YEAR	PERIOD	SYSTEM_ID	SYSTEM_NAME	SCHOOL_ID	SCHOOLNAME2008	///
...
duplicates report SCHOOLNAME2008 Lookup1  
...
list if regexm(Lookup1,"6050107")
* Just one data, ignore it
...
save ".\temp_data\cleaned_personnel_data_2008", replace
