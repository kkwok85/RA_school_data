...
import excel using ".\raw_data\personnel_data\cpi_2012-1_rpc_sch.xls"
...
(FISCAL_YEAR	PERIOD	SYSTEM_ID	SYSTEM_NAME	SCHOOL_ID	SCHOOLNAME2012	///
...
duplicates report SCHOOLNAME2012 Lookup1  



merge 1:1 SCHOOLNAME2012 Lookup1 using ".\temp_data\hs_identifier_2012"



rename SCHOOLNAME2012 SCHOOLNAME
...
list if regexm(Lookup1,"6350112")
list SCHOOLNAME if regexm(Lookup1,"6350112")
replace SCHOOLNAME = "Colquitt County Achievement Center" if SCHOOLNAME == "Colquitt County Achiecvement Center" & Lookup1 == "6350112"
replace _merge = 3 if _merge == 1 & SCHOOLNAME == "Colquitt County Achievement Center" & Lookup1 == "6350112"
...
list if regexm(Lookup1,"7410207")
replace SCHOOLNAME = "Bradfield Center - Adult Academy" if SCHOOLNAME == "Bradfield Center - Ault Academy" & Lookup1 == "7410207"
replace _merge = 3 if _merge == 1 & SCHOOLNAME == "Bradfield Center - Adult Academy" & Lookup1 == "7410207"
...
list if regexm(Lookup1,"7610118")
replace SCHOOLNAME = "The Best Academy High School at Benjamin S. Carson" if SCHOOLNAME == "The Best Academy at Benjamin S. Carson High School" & Lookup1 == "7610118"
replace _merge = 3 if _merge == 1 & SCHOOLNAME == "The Best Academy High School at Benjamin S. Carson" & Lookup1 == "7610118"
...
save ".\temp_data\cleaned_personnel_data_2012", replace
