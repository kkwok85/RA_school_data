...
import excel using ".\raw_data\dropout_data\fy2012_droprate-gr09-12_sch_disag-FERPA.xls"
...
rename (SCHOOL_YEAR-DROPOUT_RATE) (YEAR SYSTEMID SYSTEMNAME SCHOOLID SCHOOLNAME2012 GRADE_RANGE SUBGROUP STUDENT_GROUP DROPOUT_DENOMINATOR DROPOUT_COUNT DROPOUT_RATE)
...
reshape wide DROPOUT_RATE, i(SCHOOLNAME2012 Lookup1) j(STUDENT_GROUP) string
...
save ".\temp_data\cleaned_dropout_data_2012", replace
